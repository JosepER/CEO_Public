...
Non-probabililty samples are those in which the selection of units is not randomised according to principles of probability theory. There is a wide variety of non-probability sample methods [^7]. They are extensively used in market research but considered of poor quality in many fields.
