...
1. Set quota targets for the quota variables of the survey. It´s important to note that quota variables, unlike stratums, don´t need to form mutually exclusive categories[^XXX];
...
[^XXX]: For example, we can have a sample which resembles the population by categories in quota variable A and quota variable B but not for crossed categories of A and B.
