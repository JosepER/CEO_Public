...
if(!file.exists(here("interim_outputs", "jackknife", "jackknife_survey_designs_05.rds"))){
...
data_863_jackknife_survey_designs_list %>%
  write_rds(here("interim_outputs", "jackknife", "jackknife_survey_designs_05.rds"))

}else{
  
  data_863_jackknife_survey_designs_list <- read_rds(here("interim_outputs", "jackknife", "jackknife_survey_designs_05.rds"))
  
}

# ** apply calibration

if(!file.exists(here("interim_outputs", "jackknife", "jackknife_raked_resamples_05.rds"))){
...
data_863_jackknife_raked_list %>%
  write_rds(here("interim_outputs", "jackknife", "jackknife_raked_resamples_05.rds"))

}else{data_863_jackknife_raked_list <- read_rds(here("interim_outputs", "jackknife", "jackknife_raked_resamples_05.rds"))}
...
summary_jackknife_resamples_weights %>%
  write_csv(here("interim_outputs", "jackknife", "summary_jackknife_resamples_weights_05.csv"))
...
data_863_jackknife_resamples_list %>%
  write_rds(here("interim_outputs", "jackknife", "jackknife_resamples_05.rds"))

data_863_jackknife_weights_list %>%
  write_rds(here("interim_outputs", "jackknife", "weights_jackknife_resamples_05.rds"))
